...
class ChatHistory(models.Model):
    ...
    user_question = models.CharField(max_length=1000, blank=True, null=True, verbose_name="User Question")
    system_answer = models.CharField(max_length=2000, blank=True, null=True, verbose_name="System Answer")
